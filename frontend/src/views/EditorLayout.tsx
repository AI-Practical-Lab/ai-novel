      ...
      <div className="h-screen flex flex-col bg-zinc-50 dark:bg-zinc-950 overflow-hidden">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <aside
              ...
              className="border-r border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 flex flex-col shrink-0 relative"
          >
            {/* Drag Handle */}
            <div
                    ...
                    <span
                        ...
                        onClick={(e) => {
                          ...
                          setCurrentVolume(prev => {
                            if (prev?.id === vol.id) {
                              return { ...vol, milestones: prev.milestones };
                            }
                            return vol;
                          });
                          setActiveTab('volume');
                      ...
                      {vol.title}
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <button
                              ...
                              className="hidden p-1 text-zinc-400 hover:text-purple-600 dark:text-zinc-500 dark:hover:text-purple-400 transition-colors"
                              title="批量新建章节"
                          >
                      ...
                      <div className="pl-4 space-y-1">
                        {vol.chapters?.length > 0 ? (
                            vol.chapters.map(chapter => (
                                ...
                                >
                                  <span className="truncate" title={`第${vol.chapters.indexOf(chapter) + 1}章 ${chapter.title}`}>第{vol.chapters.indexOf(chapter) + 1}章 {chapter.title}</span>

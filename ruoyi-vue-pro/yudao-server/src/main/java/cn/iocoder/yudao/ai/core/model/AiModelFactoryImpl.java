package cn.iocoder.yudao.ai.core.model;
...
import cn.iocoder.yudao.ai.config.AiAutoConfiguration;
import cn.iocoder.yudao.ai.config.YudaoAiProperties;
import cn.iocoder.yudao.ai.core.model.baichuan.BaiChuanChatModel;
import cn.iocoder.yudao.ai.core.model.doubao.DouBaoChatModel;
import cn.iocoder.yudao.ai.core.model.gemini.GeminiChatModel;
import cn.iocoder.yudao.ai.core.model.hunyuan.HunYuanChatModel;
import cn.iocoder.yudao.ai.core.model.midjourney.api.MidjourneyApi;
import cn.iocoder.yudao.ai.core.model.siliconflow.SiliconFlowApiConstants;
import cn.iocoder.yudao.ai.core.model.siliconflow.SiliconFlowChatModel;
import cn.iocoder.yudao.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.iocoder.yudao.ai.core.model.siliconflow.SiliconFlowImageModel;
import cn.iocoder.yudao.ai.core.model.suno.api.SunoApi;
import cn.iocoder.yudao.ai.core.model.xinghuo.XingHuoChatModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    private static DeepSeekChatModel buildDeepSeekChatModel(String apiKey) {
        ...
        DeepSeekChatOptions options = DeepSeekChatOptions.builder().model(DeepSeekApi.DEFAULT_CHAT_MODEL)
                .temperature(0.7)
                .maxTokens(8000) // 设置最大输出 token 数，约支持 4000-5000 中文字
                .build();
